...
hostility_bc_access_tbl = hux(
  Outcome = c("Outcome", 
              "Abortion Access", "", "", "", ""), 
  Predictors = c("Predictor: Hostility Rating", 
                 "Hostile (Intercept)", 
                 "Leans Hostile", 
                 "Middle Ground", 
                 "Leans Supportive", 
...
bc_access_abortion_tbl = hux(
  Outcome = c("Outcome", 
              "Abortion Rate"), 
  Predictors = c("Predictor: Abortion Access", 
                 "% Women Living in County w/o Provider"), 
  Estimate = c("Estimate", 
               bc_access_model$coefficients[1]), 
  P_value = c("P-value", 
              summary(bc_access_model)$coefficients[,"Pr(>|t|)"][1]),
  add_colnames = FALSE
)
