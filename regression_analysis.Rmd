...
merge_data %>% 
  ...
  mutate(state_id = fct_reorder(state_id, abortion_rate_15_44_state)) %>% 
  plot_ly(x = ~abortion_rate_15_44_state, y = ~state_id, type = 'bar', orientation = 'h', width = 900, height = 700) %>% 
...
merge_data %>% 
  ...
  plot_ly(x = ~total_expend_abortion, y = ~state_id, type = 'bar', orientation = 'h', width = 900, height = 700) %>% 
