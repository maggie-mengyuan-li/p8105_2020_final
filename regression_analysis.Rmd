...
# simple linear regression: is there a relationship between contraceptive access and abortion rates by state?
bc_access_model <- lm(abortion_rate_15_44_state ~ percent_women_no_provider, data = merge_data) 
summary(bc_access_model)

# multivariate regression: is there a relationship between contraceptive access and hostility towards abortion with abortion rates by state?
...
### Is there a relationship between rate of abortion and contraceptive access by state? **moved to chunk above**
...
### Is there a relationship between teen birth rate and percent of women in need of publicly-funded contraceptive access? **probably not going to use**
